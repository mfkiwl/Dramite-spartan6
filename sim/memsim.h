...
public: 
    ...
    void apply(const BUSW wr_data, const BUSW address, 
        const uchar wr_enable, const uchar wr_mask, const uchar rd_enable, 
        uchar &wr_ack, BUSW &rd_data, uchar &rd_valid);
    void operator()(const BUSW wr_data, const BUSW address, 
        const uchar wr_enable, const uchar wr_mask, const uchar rd_enable, 
        uchar &wr_ack, BUSW &rd_data, uchar &rd_valid) {
        apply(wr_data, address, wr_enable, wr_mask, rd_enable, wr_ack, rd_data, 
            rd_valid);
    }
